...
<?php include_once 'includes/sidebar.php'; ?>
        ...
        <div class="container">
          <h3>Add your selling car details here :</h3>
          <hr>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="inputEmail4">Car Brand & Model No :</label>
              <input type="text" class="form-control" name = "car_name" id="car_name" placeholder=" car name and model" required autofocus>
            </div>
            <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="file" class="form-control-file" name="imageup1" id="exampleInputFile" aria-describedby="fileHelp" required autofocus>
            <small id="fileHelp" class="form-text text-muted">Image 1 </small>
          </div>
          <div class="form-group col-md-4">
            <label for="exampleInputFile">Image 2 upload </label>
            <input type="file" class="form-control-file" name="imageup2" id="exampleInputFile" aria-describedby="fileHelp" required autofocus>
            <small id="fileHelp" class="form-text text-muted">Image 2 </small>
          </div>

          <div class="form-group col-md-4">
            <label for="exampleInputFile">Image 3 upload </label>
            <input type="file" class="form-control-file" name="imageup3" id="exampleInputFile" aria-describedby="fileHelp" required autofocus>
